            ...
            <header>
                ...
                >
                    <div className="container d-flex justify-content-between align-items-center">
                        <Link href="#" className="navbar-brand" onMouseDown={() => handleLinkClick("/")}>
                            <Image
                                src={navIcon}
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <div className="navbar-nav nav-center-width d-flex justify-content-between">
                                <Link href="#" onMouseDown={() => handleLinkClick("/")} className={`nav-item nav-link list-style ${router.pathname === "/" ? "active" : ""}`}>
                                    Home
                                </Link>
                                {/* <!-- mobile view --> */}
                                <div
                                ...
                                <div className="nav-item dropdown d-lg-block">
                                    <Link
                                        href="#"
                                        className={`nav-link dropdown-toggle list-style ${router.pathname === "/services" ? "active" : ""}`}
                                ...
                                <Link
                                    ...
                                    className={`nav-item nav-link list-style ${router.pathname === "/casestudy" ? "active" : ""}`}
                                >
                                    Case studies
                                </Link>
                                <Link
                                    href="#"
                                    className={`nav-item nav-link list-style ${router.pathname === "/about" ? "active" : ""}`}
                                ...
                                <Link
                                    href="#"
                                    className={`nav-item nav-link list-style ${router.pathname === "/career" ? "active" : ""}`}
